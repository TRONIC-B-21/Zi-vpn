#!/bin/bash
# 🚀 ZIVPN UDP MODULE INSTALLER – ARM64 10Tbps Hyperdrop Edition 🚀
# Creator: Zahid Islam | Hyper-Modified by TRONIC-B-21 🇳🇬💥

set -euo pipefail
clear

echo -e "\n🔥🔥🔥 ZIVPN ARM64 10Tbps HYPERDROP – IGNITING HYPERDRIVE! 🔥🔥🔥"

echo -e "\n⚡ UPDATING SYSTEM (SILENT MODE) FOR MAX PERFORMANCE ⚡"
sudo apt-get update -qq && sudo apt-get upgrade -y -qq

echo -e "\n⏹️ STOP ANY RUNNING ZIVPN SERVICE – CLEAR THE RUNWAY! ⏹️"
sudo systemctl stop udp-zivpn.service 2>/dev/null || true

echo -e "\n💾 DOWNLOADING ULTRAFAST ARM64 BINARY FROM HYPERCLOUD 💾"
...
[Unit]
Description=ZIVPN UDP VPN Server – ARM64 10Tbps Hyperdrop
...
echo -e "\n✅✅✅ ZIVPN ARM64 10Tbps INSTALL COMPLETE — MAKE ISPS CRY, UNLEASH EXTREME SPEED! ✅✅✅\n"
