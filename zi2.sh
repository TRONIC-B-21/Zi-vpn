#!/bin/bash
# 🚀 ZIVPN UDP Module Installer – ARM64 (Optimized for 1 GB RAM VPS)
# Author: TRONIC-B-21
...
# 3. Download and install the ARM64 binary
...
# 11. Cleanup
rm -f zi2.sh 2>/dev/null || true

clear
echo -e "\e[96m✅ ZIVPN ARM64 installed and ready to dominate bandwidth!\e[0m"
