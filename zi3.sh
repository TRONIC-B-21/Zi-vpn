#!/bin/bash
# 🚀 ZIVPN UDP Module Installer – ARM 32‑bit (Optimized for 1 GB RAM VPS)
# Author: TRONIC-B-21

set -e
clear
echo -e "\e[93m🚀 Installing ZIVPN for ARM 32‑bit – Full Throttle Mode\e[0m"
...
# 3. Download and install the ARM 32‑bit binary
wget -q --show-progress \
  https://github.com/TRONIC-B-21/udp-zivpn/releases/download/udp-zivpn_1.4.9/udp-zivpn-linux-arm \
...
[Unit]
Description=ZIVPN UDP Server (ARM 32‑bit)
...
# 11. Cleanup
rm -f zi3.sh 2>/dev/null || true

clear
echo -e "\e[93m✅ ZIVPN ARM 32‑bit installed and blasting off! Enjoy high-speed UDP!\e[0m"
